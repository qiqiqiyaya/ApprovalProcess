...
namespace Ap.Core.Builders
{
        ...
        where TBuilder : class
    {
        ...
        private bool _isRootStateSet = false;
...
#pragma warning restore CS8618, CS9264
        ...
        private void SetInternalAction()
        {
            if (_isRootStateSet)
            {
                // only add common actions in root StateSet
            ...
            _sm.StateConfiguration.EntryTypes.Add(new ApAction(typeof(EntryFlowNode)));
            _sm.StateConfiguration.ExitTypes.Add(new ApAction(typeof(ExitFlowNode)));
